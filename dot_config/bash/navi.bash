...
### overrides bash ctrl-e (move cursor to end of line)
if [ ${BASH_VERSION:0:1} -lt 4 ]; then
  bind '"\C-e": " \C-b\C-k \C-u`_navi_widget_legacy`\e\C-e\C-a\C-y\C-h\C-e\e \C-y\ey\C-x\C-x\C-f"'
else
  bind -x '"\C-e": _navi_widget'
fi
